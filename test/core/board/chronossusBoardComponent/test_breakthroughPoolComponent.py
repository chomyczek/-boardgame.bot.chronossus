...
class TestBreakthroughPoolComponent:
    @pytest.mark.parametrize("breakthrough_type",
                             [BreakthroughType.CIRCLE, BreakthroughType.SQUARE, BreakthroughType.TRIANGLE])
    ...
    def test_remove_any_each_type_equal(self):
        breakthrough_component = BreakthroughPoolComponent()
        breakthrough_component._pool = {BreakthroughType.CIRCLE: 1, BreakthroughType.SQUARE: 1,
    ...
    def test_remove_any_one_has_more(self):
        breakthrough_component = BreakthroughPoolComponent()
        breakthrough_component._pool = {BreakthroughType.CIRCLE: 2, BreakthroughType.SQUARE: 1,
                                        BreakthroughType.TRIANGLE: 1}
        breakthrough_component.remove_any()
